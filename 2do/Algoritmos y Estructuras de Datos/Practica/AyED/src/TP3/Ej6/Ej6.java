...
public class Ej6 {
	...
	public static void main(String[] args) {
		...
		List <GeneralTree<Character>> ch1 = new LinkedList<GeneralTree<Character>> ();
		...
		List <GeneralTree<Character>> ch2 = new LinkedList<GeneralTree<Character>> ();
		...
		List <GeneralTree<Character>> ch3 = new LinkedList<GeneralTree<Character>> ();
		ch3.add(n12);
		GeneralTree<Character> a4 = new GeneralTree <Character>('G',ch3);
		
		GeneralTree<Character> n5 = new GeneralTree <Character>('F');
		List <GeneralTree<Character>> ch4 = new LinkedList<GeneralTree<Character>> ();
		...
		List <GeneralTree<Character>> children = new LinkedList<GeneralTree<Character>> ();
		...
		double minimo = 1000;
		System.out.println("El caudal minimo que pasa por el agua es: " + red.minimoCaudal(arbol, minimo));
	}
